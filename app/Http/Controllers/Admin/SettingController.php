...
class SettingController extends Controller
{
    public function index(): View
    {
        ...
        $settings = [
            ...
            'footer_phone_link_type' => SiteSetting::getValue('footer_phone_link_type', 'tel'),
            ...
            'social_daraz' => SiteSetting::getValue('social_daraz', 'https://daraz.com.bd/shop/ki2kz4ne'),
    ...
    public function update(Request $request): RedirectResponse
    {
        ...
        $request->validate([
            ...
            'footer_phone_link_type' => 'nullable|in:tel,whatsapp',
            ...
            'social_daraz' => 'nullable|string|max:500',
