    ...
    <div class="w-full space-y-6" x-data="{
        ...
        <form action="{{ route('admin.products.store') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-sm border border-slate-200 shadow-sm space-y-6">
            ...
            <div class="p-4 bg-amber-50 rounded-sm border border-amber-200 space-y-3">
                <div class="flex items-center gap-2">
                    <input id="is_new_arrival" type="checkbox" name="is_new_arrival" value="1" {{ old('is_new_arrival') == '1' ? 'checked' : '' }}
                ...
                <div class="flex items-center gap-2 pt-2 border-t border-amber-200">
                    <input id="price_is_tba" type="checkbox" name="price_is_tba" value="1" {{ old('price_is_tba') == '1' ? 'checked' : '' }}
                           class="rounded-sm border-slate-300 text-amber-600 focus:ring-amber-500 h-4 w-4">
