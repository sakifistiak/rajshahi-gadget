    ...
    <div class="p-6 space-y-6">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
            <div>
                ...
                <p class="text-xs text-gray-500 mt-1">Manage promo cards next to the main slider. (1 active banner = Full Height, 2 active banners = Split Stacked)</p>
            </div>
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="px-5 py-8 text-center text-gray-400">
                                    No promo banners added. Click "Add Promo Banner" to create one.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
