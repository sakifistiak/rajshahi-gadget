<x-app-layout>
    <div class="p-6 max-w-4xl mx-auto space-y-6">
        ...
        <div class="flex items-center justify-between bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
            <div>
                <h1 class="text-xl font-bold text-gray-900">Edit Hero Banner</h1>
                <p class="text-xs text-gray-500 mt-1">Update banner title, subtitle, image link and display order</p>
            </div>
            ...
            <form action="{{ route('admin.sliders.update', $slider) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="title" id="title" required value="{{ old('title', $slider->title) }}"
                    ...
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="image_path" id="image_path" required value="{{ old('image_path', $slider->image_path) }}"
                        ...
                        <div class="mt-2 w-32 h-16 rounded border border-gray-200 overflow-hidden bg-gray-50">
                            <img src="{{ $slider->image_path }}" alt="Preview" class="w-full h-full object-cover" />
                        </div>
                    ...
                    <div>
                        ...
                        <input type="text" name="cta_text" id="cta_text" value="{{ old('cta_text', $slider->cta_text) }}"
                               class="w-full px-3.5 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-xs focus:bg-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all" />
