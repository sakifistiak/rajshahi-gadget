<x-app-layout>
    <div class="p-6 w-full space-y-6" x-data="{ 
        ...
        <div class="flex items-center justify-between bg-white p-5 rounded-sm border border-gray-200 shadow-sm">
            <div>
                <h1 class="text-xl font-bold text-gray-900">Add New Home Slider</h1>
                <p class="text-xs text-gray-500 mt-1">Upload a slider image, set click URL, and active status</p>
            </div>
