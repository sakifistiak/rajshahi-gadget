        ...
        <div class="flex items-center justify-between p-5 bg-white rounded-xl border border-slate-200 shadow-sm">
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-0.5">Compose page content with visual rich text editor, edit raw HTML, or live preview</p>
                </div>
            </div>
        </div>
                ...
                <div class="lg:col-span-2 space-y-6">
                        ...
                        <div class="p-4">
                            ...
                            <div x-show="editorMode === 'html'" class="space-y-2">
                                ...
                                <textarea name="content" 
                                          ...
                                          @input="syncFromHtml()"
                                          rows="18" 
                                          placeholder="<h1>Welcome to Khan Gadget</h1>&#10;<p>Write your HTML content here...</p>" 
                                          ...
                                          style="tab-size: 4;">{{ old('content') }}</textarea>
                            </div>
                            ...
                            <div x-show="editorMode === 'preview'" class="min-h-[350px] p-5 border border-slate-200 rounded-lg bg-white prose prose-slate max-w-none">
                                <div x-html="previewHtml || '<p class=\'text-slate-400 italic text-xs\'>No content to preview yet. Switch to Visual Editor or HTML mode to type content.</p>'"></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 p-6 shadow-xs space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="google_form_url" id="google_form_url" rows="2" placeholder="https://docs.google.com/forms/d/e/.../viewform" class="w-full px-3 py-2 text-xs font-mono border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500">{{ old('google_form_url') }}</textarea>
                        ...
                        <div>
                            ...
                            <input type="number" name="google_form_height" id="google_form_height" min="300" max="20000" step="50" value="{{ old('google_form_height') }}" placeholder="{{ \App\Models\CustomPage::DEFAULT_GOOGLE_FORM_HEIGHT }}" style="max-width: 12rem" class="w-full px-3 py-2 text-xs border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500" />
                    ...
                    <div class="bg-white rounded-xl border border-slate-200 p-5 shadow-xs space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-slate-50 border border-slate-200 rounded-lg">
                            <div>
                                ...
                                <span class="text-[11px] text-slate-500">Display the page title at the top of the page</span>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="show_title" value="1" {{ old('show_title', true) ? 'checked' : '' }} class="sr-only peer">
                                <div class="w-9 h-5 bg-slate-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600"></div>
                            </label>
                        </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-slate-50 border border-slate-200 rounded-lg">
                            <div>
                                <span class="block text-xs font-bold text-slate-800">Show "Last Updated" Date</span>
                                <span class="text-[11px] text-slate-500">Display the "Last updated" date at the top of the page</span>
                            </div>
                            <label class="relative inline-flex items-center cursor-pointer">
                                <input type="checkbox" name="show_updated_at" value="1" {{ old('show_updated_at', true) ? 'checked' : '' }} class="sr-only peer">
                                <div class="w-9 h-5 bg-slate-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-slate-300 after:border after:rounded-full after:h-4 after:w-4 after:transition-all peer-checked:bg-blue-600"></div>
                            </label>
                        </div>
