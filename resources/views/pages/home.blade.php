...
{{-- Page H1 (SEO phase 3). Dynamic from Home Settings. --}}
<section class="container-page py-8 text-center">
    <h1 class="text-2xl font-semibold tracking-tight text-foreground sm:text-3xl">{{ !empty($homeHeadline) ? $homeHeadline : \App\Support\Seo::HOME_HEADLINE }}</h1>
    @if(!empty($homeHeadlineSubtext))
        <p class="mx-auto mt-2 max-w-3xl text-sm text-muted-foreground">{{ $homeHeadlineSubtext }}</p>
    @endif
</section>
